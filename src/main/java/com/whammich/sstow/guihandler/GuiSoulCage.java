...
public class GuiSoulCage extends GuiContainer {
	...
	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(
			Reference.MOD_ID + ":textures/gui/container/cage.png");
	...
	protected void drawGuiContainerForegroundLayer(int par1, int par2) {
		String string = this.tileCage.hasCustomInventoryName() ? this.tileCage
				.getInventoryName() : I18n.format(
				this.tileCage.getInventoryName(), new Object[0]);
